      ...
      {activeTabName === CANCEL_AT_ANY_TIME && (
        <section className="tab-content">
          <div className="container">
            <div
              id="tab-1-content"
              className={`tab-content-item ${activeTabName ===
                CANCEL_AT_ANY_TIME && "show"}`}
            >
              <div className="tab-1-content-inner">
                <div>
                  ...
                  <Link to="/shows" className="btn btn-lg">
                    Watch Free For Days
                  </Link>
                </div>
      ...
      {activeTabName === WATCH_ANYWHERE && (
        <section className="tab-content">
          <div className="container">
            <div
              id="tab-2-content"
              className={`tab-content-item ${activeTabName === WATCH_ANYWHERE &&
                "show"}`}
            >
              ...
              <div className="tab-2-content-bottom">
                ...
                <div>
                  ...
                  />
                  <p className="text-md">
                    Wath instantly or download for later
                  </p>
                  <p className="text-dark">
